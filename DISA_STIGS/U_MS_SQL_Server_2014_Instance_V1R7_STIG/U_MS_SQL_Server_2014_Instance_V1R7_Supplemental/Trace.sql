...
--	 To use SQL Server Audit in place of Trace now, in a SQL Server 2012 deployment:
--		1.  Do not run this script.
--		2.  When evaluating the SQL Server against the 2012 STIG, 
--			a. Mark all audit requirements Not Applicable;
--			b. Use the 2014 STIG to assess compliance with Audit requirements,
--				marking all other 2014 requirements Not Applicable.
--		3.  If necessary, run the Audit.sql script.
