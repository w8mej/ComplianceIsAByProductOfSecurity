...
STIG.mobileconfig - This file contains a configuration profile suitable for use with the Apple OS X STIG when it calls for a configuration profile. It can be applied to a system with 'sudo profiles -I -F STIG.mobileconfig' and removed with 'sudo profiles -D'.
