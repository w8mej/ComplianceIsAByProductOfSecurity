...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cdf="http://checklists.nist.gov/xccdf/1.1">
	...
	<!--                     FSO Customer Support                                                                                                *-->
	<!--                     e-mail: FSO_SPT@disa.mil (preferred method)                                                                         *-->
	<!--                     phone: 717-267-9264 (backup method)                                                                                 *-->
	<!--                                                                                                                                         *-->
	...
	<!--                                                                                                                                         *-->
	<!--         Thursday, 12 June, 2014 - Text fields expanded to 50,000 characters, to allow for long Fixes.                                   *-->      
        <!--         Tuesday, 31 March 2015 - "Responsibility" field display removed                                                                 *--> 
	<!--                                                                                                                                         *-->
	<!-- *****************************************************************************************************************************************-->
...
<Benchmark>    tag consists of the following:
 ...
 -->
				...
				<!-- DO NOT LOOP - XCCDF FILE FROM THIS LEVEL - DO IT WITHIN THE BENCHMARK TEMPLATE                             -->
	...
	<xsl:template match="cdf:Benchmark">
		...
		<font size="5">
			<b>XSL long text version 6/12/2014 &#160;&#160;&#160;  Sort by: &#160; Vulid</b>
			<!--ANP - 19 June 2012 -->
			<!-- <font size="5" color="blue">Vulid, ascending order    -->
			<!-- ANP - 15 March 2010 -->
		</font>
		<br/>
		<!-- Reference source            -->
       ...
       ************************************************************************************  ANP - 9 August 2010  -->
		...
		<xsl:for-each select="cdf:Group">
			...
			<xsl:sort data-type="number" select="substring(@id,3,9)"/>
			<!-- ANP - 26 July 2010 -->
   ...
   <b>STRING LENGTH:&#160;</b>
    ...
    <xsl:value-of select="substring-after(substring-before(.,'&lt;/VulnDiscussion&gt;'),
		...
		<xsl:if test="string-length(substring-after(substring-before(.,'&lt;/SecurityOverrideGuidance&gt;'), '&lt;SecurityOverrideGuidance&gt;'))>0">
			<font size="5">
				<b>Severity Override Guidance:</b>&#160;
			</font>
			<br/>
			<font size="5">
				<xsl:call-template name="buffer-overflow">
		...
		<!-- 10. Responsibility - no longer displayed                                         -->
...
<!-- hacked out a lot of code here 6/12/2014 -->


			<!-- string is between 15,001 - 50,000 characters in length -->
			<xsl:when test="$string-size &gt; 0">
				...
				<!-- print out characters # 15,001 - 16,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,15001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 16,001 - 17,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,16001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 17,001 - 18,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,17001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 18,001 - 19,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,18001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 19,001 - 20,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,19001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>



				<!-- print out characters # 20,001 - 21,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,20001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 21,001 - 22,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,21001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 22,001 - 23,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,22001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 23,001 - 24,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,23001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 24,001 - 25,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,24001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>

				<!-- print out characters # 25,001 - 26,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,25001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 26,001 - 27,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,26001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 27,001 - 28,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,27001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 28,001 - 29,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,28001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 29,001 - 30,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,29001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>



				<!-- print out characters # 30,001 - 31,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,30001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 31,001 - 32,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,31001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 32,001 - 33,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,32001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 33,001 - 34,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,33001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 34,001 - 35,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,34001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>

				<!-- print out characters # 35,001 - 36,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,35001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 36,001 - 37,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,36001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 37,001 - 38,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,37001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 38,001 - 39,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,38001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 39,001 - 40,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,39001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>



				<!-- print out characters # 40,001 - 41,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,40001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 41,001 - 42,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,41001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 42,001 - 43,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,42001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 43,001 - 44,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,43001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 44,001 - 45,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,44001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>

				<!-- print out characters # 45,001 - 46,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,45001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 46,001 - 47,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,46001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 47,001 - 48,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,47001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 48,001 - 49,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,48001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
				<!-- print out characters # 49,001 - 50,000 -->
				<xsl:call-template name="this-is-a-subroutine">
					<xsl:with-param name="string-size" select="1000"/>
					<xsl:with-param name="string-target" select="substring($string-target,49001,1000)"/>
					<xsl:with-param name="index" select="1"/>
				</xsl:call-template>
			</xsl:when>
