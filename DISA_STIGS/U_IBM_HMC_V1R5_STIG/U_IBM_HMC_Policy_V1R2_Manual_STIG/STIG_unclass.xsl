...
&#160;
		...
		<!-- ANP - 15 March 2010 - Sort order indicated in the title page -->
                                          ...
                                          <font size="5">
                        <b>XSL Release 6/19/2012 &#160;&#160;&#160;  Sort by: &#160; STIGID</b>     <!--ANP - 19 June 2012 -->
			</font>
			<br/>
   ...
   <b>STRING LENGTH:&#160;</b>
    ...
    <xsl:value-of select="substring-after(substring-before(.,'&lt;/VulnDiscussion&gt;'),
		...
		<!-- There must be text between  "<Responsibility>this is responsibility text</Responsibility>"      -->
		<xsl:if test="string-length(substring-after(substring-before(.,'&lt;/Responsibility&gt;'), '&lt;Responsibility&gt;'))>0">
			<font size="5">
				<b>Responsibility:</b>&#160;</font>    <!-- Responsibility now takes only one line - 15 December 2009 -->
			<!-- <br/>   -->                                          <!-- 15 December 2009 -->
			<font size="5">
				<xsl:value-of select="substring-after(substring-before(.,'&lt;/Responsibility&gt;'),
                                   '&lt;Responsibility&gt;')"/>
			</font>
			<br/>
		</xsl:if>
